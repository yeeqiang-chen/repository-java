package com.yiqiang.repository.javase.thread.executorpool.chapter05;
...
/**
 * Title:
 * Description: Main class of the example. Launch three tasks using the invokeAll() method
 * and then prints their results to the console
 * Create Time: 2017/1/20 0020 2:02
 *
 * @author: YEEQiang
 * @version: 1.0
 */
